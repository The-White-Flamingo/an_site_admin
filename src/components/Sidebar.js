    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 bg-black/40 z-50 flex">
          <div className="w-64 bg-white h-full p-4 shadow-xl sidebar">
            ...
            <nav className="menu">
              <MenuItem label="Dashboard" icon={dashboardIcon} active={active === "Dashboard"} onClick={() => setActive("Dashboard")} />
              <MenuItem label="My Surveys" icon={surveyIcon} active={active === "My Surveys"} onClick={() => setActive("My Surveys")} />
              <MenuItem label="Find Surveyors" icon={findIcon} active={active === "Find Surveyors"} onClick={() => setActive("Find Surveyors")} />
              <MenuItem label="Payments" icon={paymentIcon} active={active === "Payments"} onClick={() => setActive("Payments")} />
              <MenuItem label="Messages" icon={messageIcon} active={active === "Messages"} onClick={() => setActive("Messages")} />
              <MenuItem label="Help" icon={helpIcon} active={active === "Help"} onClick={() => setActive("Help")} />
              <MenuItem label="Account" icon={settingsIcon} active={active === "Account"} onClick={() => setActive("Account")} />
              <MenuItem label="Disputes" icon={disputeIcon} active={active === "Disputes"} onClick={() => setActive("Disputes")} />
              <MenuItem label="Sign Out" icon={logoutIcon} active={active === "Sign Out"} onClick={() => setActive("Sign Out")} />
            </nav>
